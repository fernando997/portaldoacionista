...
const adminItems = [
  { title: 'Acionistas', url: '/admin', icon: Users },
  { title: 'Cadastrar', url: '/admin/cadastrar', icon: UserPlus },
  { title: 'Onboarding', url: '/admin/onboarding', icon: Link2 },
];
    ...
    <Sidebar collapsible="icon">
      <SidebarContent className="bg-gradient-to-b from-[hsl(220,60%,12%)] to-[hsl(220,60%,8%)]">
        <SidebarGroup>
          ...
          {!collapsed && (
            <div className="mx-3 mb-4 px-3 py-2.5 rounded-xl bg-[hsl(210,80%,52%)]/10 border border-[hsl(210,80%,52%)]/20">
              <div className="flex items-center gap-2">
                <Shield className="w-3.5 h-3.5 text-[hsl(210,80%,60%)]" />
        ...
        {!collapsed && (
          <div className="px-3 py-3 rounded-xl bg-[hsl(0,0%,100%)]/[0.05] border border-[hsl(0,0%,100%)]/[0.08] mb-2">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[hsl(220,60%,18%)] to-[hsl(220,60%,30%)] border border-[hsl(0,0%,100%)]/10 flex items-center justify-center shrink-0">
                <span className="text-xs font-bold text-[hsl(0,0%,98%)]">A</span>
              </div>
              <div className="min-w-0">
                <p className="font-semibold text-sm text-[hsl(0,0%,95%)]">Administrador</p>
                <p className="text-[11px] text-[hsl(210,30%,55%)] mt-0.5">Acesso total</p>
              </div>
            </div>
          </div>
        )}
