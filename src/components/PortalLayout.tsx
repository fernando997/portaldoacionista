    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-14 sm:h-20 flex items-center border-b bg-card/80 backdrop-blur-sm px-3 sm:px-6 gap-3 sticky top-0 z-30">
            <SidebarTrigger />
            <div className="flex-1 flex items-center gap-3">
              <img src={logo} alt="Modo Corre" className="h-10 sm:h-16 w-auto" />
            </div>
