...
CREATE TABLE public.profiles (
  ...
  name TEXT NOT NULL,
  email TEXT,
  group_name TEXT DEFAULT 'Grupo Modo Corre',
  participation_percent NUMERIC DEFAULT 0,
...
BEGIN
  INSERT INTO public.profiles (user_id, name, email) VALUES (NEW.id, COALESCE(NEW.raw_user_meta_data->>'name', NEW.email), NEW.email);
  RETURN NEW;
END; $$;
